...
<div itemtype="#" itemscope="" class="product-miniature">
    <div id="smartblogpost-{$post.id_post|escape:'htmlall':'UTF-8'}" class="thumbnail-container">


<div class="blog_header">   
	<span>
		{if $smartshowauthor ==1}{l s='Posted by' mod='smartblog'} 
			<span itemprop="author">&nbsp;<i class="icon icon-user"></i>&nbsp;
		...
		<div class="button-container">  
			<a title="{$post.meta_title|escape:'htmlall':'UTF-8'}" href="{$smartbloglink->getSmartBlogPostLink($post.id_post,$post.link_rewrite)|escape:'htmlall':'UTF-8'}" class="button lnk_view btn btn-default">
				<span>{l s='Read more' mod='smartblog'}</span>
			</a>
		</div>
