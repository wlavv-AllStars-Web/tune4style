...
<div class="product-line-grid">
  ...
  <div class="product-line-grid-left col-md-3 col-xs-4">
    <span class="product-image media-middle">
		...
		{else}
			<img src="{$urls.img_ps_url}p/{$language.iso_code}-default-cart_default.jpg" alt="{$product.name|escape:'quotes'}">
		{/if}
    </span>
  </div>
    ...
    {if $product.customizations|count}
      {block name='cart_detailed_product_line_customization'}
        {foreach from=$product.customizations item="customization"}
          <a class="product-customizations-popup" href="#" data-toggle="modal" data-target="#product-customizations-modal-{$customization.id_customization}">{l s='Product customization' d='Shop.Theme.Catalog'}</a>
