                        ...
                        {if isset(Module::getInstanceByName('reviewsreply')->active)}
                            {if Module::getInstanceByName('reviewsreply')->active == true && $identifier == 'id_product_comment'}
                                <div class="pull-right">
                                    <a onclick="$(this).closest('tr').next('tr').show();" class="btn btn-small btn-default"><i class="icon-pencil"></i> {l s='Reply' d='Admin.Global'}</a>
                                </div>
                            {/if}
                        {/if}
                    {/if}
                            ...
                            <form method="post">
                                ...
                                <div class="col-lg-12">
                                    <button class="btn btn-large btn-success">
                                        <i class="icon-save"></i> {if isset($reply.0)}{l s='Save reply' d='Admin.Global'}{else}{l s='Add reply' d='Admin.Global'}{/if}
                                    </button>
                                </div>
                            </form>
                        </td>
    ...
    <tr>
        <td class="list-empty" colspan="{count($fields_display)+1}">
            <div class="list-empty-msg">
                ...
                {l s='No records found' d='Admin.Global'}
            </div>
        </td>
    </tr>
{/if}
